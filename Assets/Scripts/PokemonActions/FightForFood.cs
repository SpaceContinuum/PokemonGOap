...
public class FightForFood : Fight
{
    ...
    public override void Reset()
    {
        ...
        preConditions[preConditions.Length] = new WorldState(WorldState.Label.attackingForFood, 0);

        WorldState[] afterNew = new WorldState[afterEffects.Length+1];
        afterEffects.CopyTo(afterNew, 0);
        afterEffects = afterNew;
        afterEffects[afterEffects.Length] = new WorldState(WorldState.Label.hasFood, 0);
